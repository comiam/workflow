	...
	Object f_evalActionExp(Struct ae, int ai, Struct aenv, Struct afns) {
		...
		case 3/*ActionCallDebug*/: {
			...
			case 44/*None*/: {
				...
				if ((((Struct)runtime.m_dynamic.f_flow(l37_r)).getTypeId() == 27||runtime.m_array.f_contains(l33_vargs, SingletonStructs.str_IllegalStruct))) {
