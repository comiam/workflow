...
final class Module_array {
	...
	boolean f_doForall(Object[] aa, int ai, int an, Func1<Boolean,Object> afn) {
	 TAIL_CALL: for(;;) {
		if ((ai<an)) {
	...
	boolean f_forall(Object[] aa, Func1<Boolean,Object> afn) {
		return f_doForall(aa, 0, runtime.h_Native.length(aa), afn);
	}
