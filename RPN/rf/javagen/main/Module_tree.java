...
final class Module_tree {
	...
	Object[] f_convertTreeToArray(Struct atree, Func2<Object,Object, Object> aconv) {
		if (f_largeTree(atree)) {
			final SingletonStruct l2_$1 = SingletonStructs.str_EmptyList;
			final Func2<Object,Object, Object> l4_conv = aconv;
			final Func3<Struct_Cons,Object, Object, Struct> l3_$0 = new Func3<Struct_Cons,Object,Object,Struct>() {
				final public Struct_Cons invoke(final Object ak, final Object av, final Struct al) {
					return (new Struct_Cons(l4_conv.invoke(ak, av), al));
				}
			};
			return runtime.h_Native.list2array(((Struct)f_foldTree(atree, l2_$1, ((Func3<Object,Object, Object, Object>)(Func3)l3_$0))));
		} else {
			final Object[] l7_$6 = SingletonStructs.arr_empty;
			final Func2<Object,Object, Object> l9_conv = aconv;
			final Func3<Object[],Object, Object, Object[]> l8_$5 = new Func3<Object[],Object,Object,Object[]>() {
				final public Object[] invoke(final Object akey, final Object avalue, final Object[] aacc) {
					return runtime.m_array.f_arrayPush(aacc, l9_conv.invoke(akey, avalue));
				}
			};
			return ((Object[])f_foldTree(atree, l7_$6, ((Func3<Object,Object, Object, Object>)(Func3)l8_$5)));
		}
	}
	...
	Struct f_mapTree2(Struct atree, Func2<Object,Object, Object> afn) {
		Struct l0__tmp = atree;
		switch (l0__tmp.getTypeId()) {
		case 108/*TreeEmpty*/: {
			return ((Struct)SingletonStructs.str_TreeEmpty);
		...
		case 109/*TreeNode*/: {
			...
			final Struct l10_right = l1__tmp.f_right;
			final int l11_depth = l1__tmp.f_depth;
			return (new Struct_TreeNode(l7_k, afn.invoke(l7_k, l8_v), f_mapTree2(l9_left, afn), f_mapTree2(l10_right, afn), l11_depth));
		}
		default:
			throw new RuntimeException("Unexpected struct in switch: "+l0__tmp.getTypeName());
		}
	...
	Object[] f_tree2pairs(Struct atree) {
		final Func2<Struct_Pair,Object, Object> l1_$0 = new Func2<Struct_Pair,Object,Object>() {
			final public Struct_Pair invoke(final Object ak, final Object av) {
				return (new Struct_Pair(ak, av));
			}
		};
		return f_convertTreeToArray(atree, ((Func2<Object,Object, Object>)(Func2)l1_$0));
	}
