...
final class Module_pegcode_lib {
	final main runtime;
	Module_pegcode_lib(main runtime) {
	...
	Object f_evalActionExp(Struct ae, int ai, Struct aenv, Struct afns) {
		...
		case 4/*ActionCallDebug*/: {
			...
			case 64/*None*/: {
				...
				if ((((Struct)runtime.m_dynamic.f_flow(l37_r)).getTypeId() == 36||runtime.m_array.f_contains(l33_vargs, SingletonStructs.str_IllegalStruct))) {
