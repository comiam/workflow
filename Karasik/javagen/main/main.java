...
public final class main extends FlowRuntime {
	...
	final Module_logic_types m_logic_types = new Module_logic_types(this);
	final Module_vmtypes m_vmtypes = new Module_vmtypes(this);
	...
	final Module_vmcompiler m_vmcompiler = new Module_vmcompiler(this);
	...
	final Module_gram_engine m_gram_engine = new Module_gram_engine(this);
